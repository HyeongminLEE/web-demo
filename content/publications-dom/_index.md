...
<h5 class="paper-title">깊이 정보를 이용한 손 검출</h5>
...
<h5 class="paper-title">HEVC 고속화를 위한 초기 CU size 결정 방법</h5>
<div class="paper-author">이재호, 이상윤</div>
*대한전자공학회 정기총회 및 추계학술대회*, Nov. 2012

<h5 class="paper-title">x264 병렬 부호화기의 저지연 구조</h5>
<div class="paper-author">박대현, 김성완, 이재호, 임경민, 박창현, 이상윤</div>
*신호처리합동학술대회*, Sep. 2012

<h5 class="paper-title">축소 다변수 다항식 분류기를 이용한 고속 차량 검출 방법</h5>
<div class="paper-author">김중락, 유선진, Kar-Ann Toh, 김도훈, 이상윤</div>
*한국통신학회 논문지*, Aug. 2012

<h5 class="paper-title">깊이 정보를 이용한 자동적인 객체 정밀 분할 및 깊이 정보 추정</h5>
<div class="paper-author">이경재, 황진규, 반유석, 오지훈, 이상윤</div>
*대한전자공학회 하계종합학술대회*, Jun. 2012

<h5 class="paper-title">조명 잡음 제거를 위한 웨이블릿과 주성분분석을 이용한 얼굴 인식</h5>
<div class="paper-author">박창현, 김성완, 이재호, 임경민, 박대현, 이상윤</div>
*대한전자공학회 하계종합학술대회*, Jun. 2012

<h5 class="paper-title">깊이 필터링을 이용한 손 검출 및 추적</h5>
<div class="paper-author">김재성, 유선진, 김중락, 김수연, 이상윤</div>
*대한전자공학회 하계종합학술대회*, Jun. 2012

<h5 class="paper-title">고유특징 정규화 및 추출 기법을 이용한 얼굴 스케치 인식 시스템</h5>
<div class="paper-author">배한별, 김중락, 김수연, 반유석, 이상윤</div>
...
<h5 class="paper-title">HEVC CAVLC 성능 향상을 위해 Run Mode Coding 에서의 CN스위칭 방법</h5>
<div class="paper-author">이재호, 김성완, 임경민, 박대현, 이상윤</div>
*신호처리합동학술대회*, Sep. 2011

<h5 class="paper-title">HEVC CAVLC 성능 향상을 위한 적응 구문 추가 방법</h5>
<div class="paper-author">김성완, 이재호, 임경민, 박대현, 이상윤</div>
*신호처리합동학술대회*, Sep. 2011

<h5 class="paper-title">ANMM(Average Neighborhood Margin Maximization)에 기반한 피부색과 비피부색 분리력 향상 기법</h5>
<div class="paper-author">반유석, 이상윤</div>
*한국방송공학회 하계학술대회*, Jul. 2011

<h5 class="paper-title">2차원 영상의 얼굴 각도와 위치 판정</h5>
<div class="paper-author">김우원, 황진규, 이상윤</div>
*한국방송공학회 하계학술대회*, Jul. 2011

<h5 class="paper-title">깊이 정보를 이용한 손 검출 방법</h5>
<div class="paper-author">박상헌, 김중락, 김재성, 이상윤</div>
*한국방송공학회 하계학술대회*, Jul. 2011

<h5 class="paper-title">Elongated Radial Basis Function for Nonlinear Representation of Face Data</h5>
...
<h5 class="paper-title">Isolation External Factors for Robust Face Recognition</h5>
